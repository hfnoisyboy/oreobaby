...
module.exports = {
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '917510153501@s.whatsapp.net' : process.env.TAG_REPLY,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    AFN: process.env.ALL_CAPTION === undefined ? '*OREOBABY bot by NIYABABY*' : process.env.ALL_CAPTION,
    ...
    YAK: process.env.YAK === undefined ? '917510153501,0' : process.env.YAK,
