...
const {Message, StringSession, Image, Video} = require('./niya/');
...
async function whatsAsena () {
    ...
    conn.on('connecting', async () => {
        console.log(`${chalk.green.bold('NIYA')}${chalk.blue.bold('BABY')}
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('NIYABABY working! 😍')
        );
    });
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~♥️🕊️______~ NIYABABY ~_____🕊️♥️~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n' + '\n https://wa.me/917510153501'
                                    , MessageType.text);
                            }
                        }
                    }
